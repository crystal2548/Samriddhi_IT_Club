...
export function OCPermissions() {
  ...
  async function handleAction(id: string, status: string, requesterId: string, permission: string) {
  ...
  const STATUS_S: Record<string, { bg: string, color: string, border: string }> = { pending: { bg: 'rgba(245,158,11,0.1)', color: '#F59E0B', border: 'rgba(245,158,11,0.25)' }, approved: { bg: 'rgba(16,185,129,0.1)', color: '#10B981', border: 'rgba(16,185,129,0.25)' }, rejected: { bg: 'rgba(239,68,68,0.1)', color: '#EF4444', border: 'rgba(239,68,68,0.25)' } }
