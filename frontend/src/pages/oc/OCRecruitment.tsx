...
const EMPTY: RecruitmentCycle = { type: 'general', title: '', description: '', status: 'open', opens_at: '', closes_at: '' }
...
export default function OCRecruitment() {
  ...
  const [form, setForm] = useState<RecruitmentCycle>(EMPTY)
  ...
  const STATUS: Record<string, { bg: string, color: string, border: string }> = { closed: { bg: 'rgba(107,114,128,0.1)', color: '#6B7280', border: 'rgba(107,114,128,0.25)' }, open: { bg: 'rgba(16,185,129,0.1)', color: '#10B981', border: 'rgba(16,185,129,0.25)' }, reviewing: { bg: 'rgba(245,158,11,0.1)', color: '#F59E0B', border: 'rgba(245,158,11,0.25)' }, done: { bg: 'rgba(0,212,255,0.1)', color: 'var(--cyan)', border: 'rgba(0,212,255,0.25)' } }
