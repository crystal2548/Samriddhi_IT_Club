  ...
  return (
    ...
    >
      <div className="container mx-auto px-6">
        <div className="flex items-center justify-between h-16 gap-x-4 xl:gap-x-12">

          {/* ── Logo ─────────────────────────────────────── */}
          <Link to="/" className="flex items-center gap-2.5 flex-shrink-0">
            <div className="flex items-center justify-center w-9 h-9 rounded-lg border-[1.5px] border-[#00D4FF] bg-[#00D4FF]/10 overflow-hidden">
              {settings.logo_url ? (
            ...
            <span className="text-sm font-bold tracking-tight text-white sm:tracking-wide">
          ...
          <div className="hidden lg:flex items-center gap-4 xl:gap-6">
            {NAV_LINKS.map((link: { path: string, label: string }) => (
              <NavLink
                ...
                to={link.path}
                className={({ isActive }) =>
                  `text-[13px] xl:text-sm font-medium transition-colors duration-200 ${isActive
                    ? 'text-white'
          ...
          <div className="hidden lg:flex items-center gap-2 xl:gap-3">
            ...
            {/* Search */}
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm bg-white/5 border border-white/10 text-gray-400 min-w-[120px] xl:min-w-[160px] cursor-pointer hover:bg-white/10 transition-colors">
            ...
            {user ? (
              ...
              <div className="relative" ref={dropdownRef}>
                <button
                  ...
                  className={`flex items-center gap-1.5 rounded-lg pl-1 pr-1.5 py-1 transition-all outline-none ${dropdownOpen ? 'bg-white/5' : 'bg-transparent hover:bg-white/5'}`}
                >
                  {/* Avatar */}
                  {profile?.photo_url ? (
                    <img
                  ...
                  <span className="text-sm font-medium text-white max-w-[80px] xl:max-w-[120px] overflow-hidden truncate">
