import type { NavLink, NavSection } from '../types/index'
...
// ─── Resource Tracks ──────────────────────────────────────────────────────────
export const RESOURCE_TRACKS: { value: string; label: string }[] = [
  { value: 'all',      label: 'All' },
...
// ─── Sponsor Tiers ────────────────────────────────────────────────────────────
export const SPONSOR_TIERS: { value: string; label: string }[] = [
...
// ─── OC Sidebar Links ─────────────────────────────────────────────────────────
export const OC_NAV: NavSection[] = [
  {
    section: 'Overview',
    links: [
